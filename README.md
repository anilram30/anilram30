...
## ANYmal-C — walking control by NMPC + moving-horizon estimation
...
**Repo: anymal-srbd-mpc-mhe** · **Site**: anilram30.github.io/anymal-srbd-mpc-mhe · **Report**: 25 pages, full model derivation and closed-loop results
